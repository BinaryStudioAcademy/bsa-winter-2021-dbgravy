...
router
  .post('/token', refreshTokenMiddleware, run(req => refreshToken(req.body.refreshToken, req.user as ITransportedUser)))
  .post('/sign-in', authenticationMiddleware, run(req => login(null, req.user as ITransportedUser)))
