...
export class componentsEntities1616086931580 implements MigrationInterface {
    name = 'componentsEntities1616086931580'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "button" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "componentId" uuid NOT NULL, "queryId" uuid NULL, "text" character varying NOT NULL, "color" character varying NOT NULL, CONSTRAINT "REL_fb96e8d5571a89dbce61dcb52f" UNIQUE ("componentId"), CONSTRAINT "PK_a4df4e4f7a5882bc94442d3f209" PRIMARY KEY ("id"))`);
